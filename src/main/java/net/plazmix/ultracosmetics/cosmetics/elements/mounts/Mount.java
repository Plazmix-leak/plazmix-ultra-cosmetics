...
import net.plazmix.ultracosmetics.cosmetics.elements.mounts.impl.MountDragon;
...
public abstract class Mount<E extends Entity> extends Cosmetic<MountType> implements Updatable {
    ...
    public Mount(CosmeticPlayer cosmeticPlayer, MountType type, UltraCosmetics ultraCosmetics) {
        super(ultraCosmetics, Category.MOUNTS, cosmeticPlayer, type);
    }
